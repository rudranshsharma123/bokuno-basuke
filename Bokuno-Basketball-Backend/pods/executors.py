...
class MyTransformer(Executor):
    """A simple Transformer Class
        Simply used to get the embedddings from the best model, which would then be used to determine the similarty between the text entered and the text indexed
    """
...
class MyIndexer(Executor):
    """A simple class used for indexing 
        An indexer is needed to store the data into the file system, this is very simple indexr which just, extends the docs which it gets from the flow above
    """
